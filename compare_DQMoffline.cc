...
void compare_DQMoffline(void){
  TFile* f1 = new TFile("/afs/cern.ch/user/m/muell149/work/muell149/CMSSW_6_2_0_pre5/src/DQMOffline/Trigger/test/pre5DQM.root");
  TFile* f2 = new TFile("/afs/cern.ch/user/m/muell149/work/muell149/CMSSW_6_2_0_pre5/src/DQMOffline/Trigger/test/pre7DQM.root");
  char* r1="pre 5";
  char* r2="pre 7";
